...
m_terms = apply(d_concs, 1, function(co) get_ma_terms(S, co))
...
normal = replicate(4, get_ma_terms(S, noise(d_concs[1,])))
disease = replicate(4, get_ma_terms(S, noise(d_concs[3,])))
...
production are close to the actual alteration (90-fold predicted vs 100-fold truth).
