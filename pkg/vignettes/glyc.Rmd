...
S = get_stochiometry(glycolysis)  # to get the irreversible stochiometric matrix
sbml_file = system.file("extdata", "BIOMD0000000042.xml", package="dycone") 
species_data = get_sbml_species(sbml_file) 
...
```{r}
h = hyp(kc, d_basis[[3]], glycolysis, tol=1e-2)
print(h)
```
